...
def crow_first(n):
    ...
    with open('JD_Phone.csv', 'a', newline='', encoding='utf-8')as f:
        ...
        for data in datas:
            ...
            p_urll = data.xpath('div/div[@class="p-name p-name-type-2"]/a/@href')
            ...
            print([p_name[0].xpath('string(.)'), p_price[0],p_urll[0]])
            write.writerow([p_name[0].xpath('string(.)'), p_price[0],p_urll[0]])
    f.close()
